...
const ActivityLog = () => {
  ...
  const getActionStyles = (action) => {
    ...
    if (act === 'CREATE') return 'bg-green-50 text-green-700 border-green-200';
    if (act === 'UPDATE') return 'bg-amber-50 text-amber-700 border-amber-200';
    if (act === 'APPROVE') return 'bg-blue-50 text-blue-700 border-blue-200';
    if (act === 'DELETE' || act === 'REJECT') return 'bg-red-50 text-red-700 border-red-200';
